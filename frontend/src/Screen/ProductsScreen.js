...
function ProductsScreen(props) {
    ...
    const { loading: loadingSave, product: successSave, error: errorSave } = productSave;
                ...
                <div className="form">
                    <form onSubmit={submitHandler}>
                        <ul className="form-container">
                            ...
                            <li>
                                <label htmlFor="countStock">
                                    Count In Stock
                                </label>
                                <input type="number" name="countStock" id="countStock" value={countInStock} onChange={(e) => setCountInStock(e.target.value)}></input>
                            </li>
                            <li>
